...
namespace RLGC {
	...
	// on-ground, at rest, facing the ball. By default the ball is static on the ground in the
	// field interior; the optional height/drift/boost params turn the same placement into an
	// aerial drill (ball hanging overhead, drifting down, cars guaranteed fuel to go get it).
