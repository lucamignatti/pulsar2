...
`analysis/probes/data/dataset.npz` — validated by CarEnergy computed `E[r]` −2.874e-3 vs live panel
...
7. **The offline probe toolchain is 512-wide; the live trunk is 1152-wide and the policy head is now
   768.** `analysis/probes/load_checkpoint.py` hard-codes expected shapes and `dataset.npz` stores
