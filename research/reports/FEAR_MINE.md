> **Status: CANONICAL (graduated).** The disagreement-mining criterion validated
> here was deployed and is live in the trainer; `src/ExampleMain.cpp` cites it.
>
...
`research/tools/fear_census.py` remains as a MANUAL research tool (its
