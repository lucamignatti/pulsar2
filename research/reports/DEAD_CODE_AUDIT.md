...
4,242 LOC gym layer (`RLGymCPP/src`) + 9,787 LOC Python (`research/tools`) +
...
## 15. research/tools (offline toolkit)
...
`research/tools/mechanic_census.py` counts `wavedash_like`, `flip_cancel_ish`,
...
| `git add research/reports/REWARD_SHAPING.md` | prevents loss of the newest canonical report |
| Fix `research/tools/README.md` (3.1 → resid, tickSkip 4 → 8) | doc |
