...
direction and run the pre-registered dose-response sweep (../reports/archive/MOVEMENT_PHASE0.md — read
...
def derive_movement_direction(h2, rd, rng, v_commit=None):
    ...
    Quarter-scale finding (recorded in ../reports/archive/MOVEMENT_PHASE0.md results): with distance x time
...
def main():
    ...
    ckpt = args.ckpt or copy_checkpoint(HERE.parent / "data" / "ckpt_cache_movement")
    ...
    # ---- pre-registered verdict (../reports/archive/MOVEMENT_PHASE0.md) ----
