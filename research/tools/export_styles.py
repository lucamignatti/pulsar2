...
Only causally-validated directions ship (Phase-0 program, ../reports/archive/STEERING_PHASE0_40.md):
...
def main():
    ...
    ckpt = args.ckpt or copy_checkpoint(HERE.parent / "data" / "ckpt_cache")
    ...
    meta = {"checkpoint": int(ckpt.name), "rows": args.rows,
            "note": "offline-validated styles only; see research/reports/archive/STEERING_PHASE0_40.md"}
